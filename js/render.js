...
function renderPlan() {
  ...
  function guideInputs(item) {
    ...
    return `<div class="plan-guide"><label>Tensión (s)<input data-plan-guide="tension" type="number" min="0" inputmode="numeric" value="${guide.tension ?? 0}"></label><label>Pausa (s)<input data-plan-guide="pause" type="number" min="0" inputmode="numeric" value="${guide.pause ?? 0}"></label><label>Distensión (s)<input data-plan-guide="distension" type="number" min="0" inputmode="numeric" value="${guide.distension ?? 0}"></label><label>Descanso (s)<input data-plan-guide="rest" type="number" min="0" inputmode="numeric" value="${guide.rest ?? 0}"></label></div>`;
  }
